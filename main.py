...
def run_game():
    ...
    while not game_over:
        while game_close:
            ...
            reenter_message = message_font.render("PRESS r FOR RE GAME", True, green)
            stop_message = message_font.render("PRESS s FOR STOP", True, green)
            game_display.blit(game_over_message, [width / 3, height / 3])
            game_display.blit(reenter_message, [width / 2, height / 2])
